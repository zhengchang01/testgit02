		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="${pageContext.request.contextPath}/index.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;全部商品&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;图书列表
					</div>
					<table cellspacing="0" class="listcontent">
						<tr>
							<td>
								<h1>商品目录</h1>
								<hr />
								<h1>全部商品</h1>&nbsp;&nbsp;&nbsp;&nbsp;共${pageModel.getRecordCount()}种商品
								<hr />
								...
								<div class="pagination">
									<ul>
										<yyf:pager pageIndex="${requestScope.pageModel.pageIndex}" 
	  	                                           ...
	  	                                           submitUrl="${pageContext.request.contextPath}/client/products/findProductByCategory.do?pageIndex={0}"/>
									</ul>
								</div></td>
						</tr>
					</table>
