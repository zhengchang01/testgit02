...
<script type="text/javascript">
	...
	function createOrder(){
		...
		if(receiverAddress == ''){
			...
			alert("请填写收货人联系方式！");
		}else if(receiverAddress != ''&&receiverName != ''&&receiverPhone != ''){
								...
								<td><table width="100%" border="0" cellspacing="0">
										...
										<tr>
											<td><table cellspacing="1" class="carttable">
												...
												<p>
													收货地址：<input name="receiverAddress" type="text" id="receiverAddress" value=""
														style="width:350px" />&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"></a>
													<br /> 收货人：&nbsp;&nbsp;&nbsp;&nbsp;<input
														name="receiverName" type="text" value="${username}" id="receiverName"
														style="width:150px" />&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"></a>
													<br /> 联系方式：<input type="text" name="receiverPhone" id="receiverPhone"
												...
												<p style="text-align:right">
													<img src="images/gif53_029.gif" width="204" height="51"
														...
														<%-- <input type="image" src="${pageContext.request.contextPath }/client/images/gif53_029.gif" onclick="createOrder();"/> --%>
												</p>
											</td>
										</tr>
									</table>
