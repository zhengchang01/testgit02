...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/admin/order/findOrderByManyCondition.do"
		method="post">
							...
							<c:forEach items="${orders}" var="order">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/admin/order/findOrderById.do?id=${order.id}">
											<img
									...
									<td align="center" style="HEIGHT: 22px"><c:if
											...
											<a
												href="${pageContext.request.contextPath}/admin/order/delOrderById.do?id=${order.id}">
												<img
